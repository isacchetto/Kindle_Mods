...
local text_size = 0.7 	-- Adjust from 0 to 1
local move_on_x = -23		-- Adjust how far left the badge should sit. 5
local move_on_y = -5	-- Adjust how far up the badge should sit.
