...
ReaderView.paintTo = function(self, bb, x, y)
    ...
    local left_max_width_pct = 80 -- this % is how much space the left corner can use before "truncating..."
    ...
    local left_corner_header = string.format("%s %s %s", book_author, separator.en_dash, book_title)
    local right_corner_header = string.format("%s %s %s", time, separator.bar, battery)
